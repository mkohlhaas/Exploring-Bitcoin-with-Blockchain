...
electricity_rates = {"rate_slabs": [
    {"min": 1, "max": 30, "unit_price": 4},
    {"min": 31, "max": 100, "unit_price": 5.45},
    {"min": 101, "max": 200, "unit_price": 7},
    {"min": 201, "unit_price": 8.05}]}
...
def getBitcoinMinedPerMonth(hashrate: int, bits: bytes, blk_reward: int):
    btc_mined_per_month = getBitcoinMiningRate(
        hashrate, bits, blk_reward) * 6 * 24 * 30
