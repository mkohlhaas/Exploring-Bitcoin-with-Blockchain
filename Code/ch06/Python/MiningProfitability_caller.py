...
from MiningProfitability import miningReturn
from MiningProfitability import getBlockHeaderBytes
from MiningProfitability import MINER_POWER_WATT
from MiningProfitability import MINER_HASH_RATE

if __name__ == '__main__':
    blk_hash = bytes.fromhex('000000000000000000079dc864537510659e14439ff5f4a2'
                             '08231bcf276358ba')[::-1]
    ...
    mining_return = miningReturn(
        MINER_POWER_WATT, MINER_HASH_RATE, bits_b, blk_reward)
