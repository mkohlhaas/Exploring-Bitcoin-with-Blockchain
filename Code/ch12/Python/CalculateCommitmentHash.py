...
def calculateCommitmentHash(blkhash_b: bytes, block_db):
    ...
    with open(txn_filepath, 'rb') as txn_file:
        ...
        with mmap.mmap(txn_file.fileno(), 0,
            ...
            print('Calculated Witness Merkle Root Hash\t = %s' %
                  witness_merkle_root_h)
            ...
            commitment_hb = hashOfJoinedStr(
                witness_merkle_root_h, witness_reserved_value)
