...
rpc_connection = AuthServiceProxy(
    "http://%s:%s@127.0.0.1:18332" % ('test', 'test'))
...
def createVersionPayload(s: socket, version: int):
    ...
    payload1 = version_b + services_b + timestamp_b + addr_recv_b
    payload = payload1 + addr_trans_b + nonce_b + user_agent_b + start_height_b
    return payload
